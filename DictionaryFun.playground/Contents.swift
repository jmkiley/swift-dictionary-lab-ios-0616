...
let state = "New York"
// write your code here
var newYorksCapital = statesAndCapitals[state]
if let newYorksCapital = newYorksCapital {
    print("The capital of \(state) is \(newYorksCapital)")
}
/*: question11
 ...
 */
// write your code here
var bandsAndBandMembers : [String : [String]] = [
    "Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
    "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
    "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
    "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]
 ...
 */
//A variable dictionary with strings as keys and arrays of strings as values
/*: question13
...
let bandName = "Pixies"
// write your code here
var pixiesMembers = bandsAndBandMembers[bandName]
if let pixiesMembers = pixiesMembers {
    print(pixiesMembers)
}
/*:
 [Solution](solution)
